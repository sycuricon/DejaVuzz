...
def statistic_trigger(folder_name):
    ...
    trigger_record_path = os.path.join(folder_name, 'template_repo', 'trigger_iter_record')
...
if __name__ == "__main__":
    case_dataset = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'build')
    statstic_type(case_dataset, 'BOOM_trigger_dejavuzz')
    statstic_type(case_dataset, 'BOOM_trigger_dejavuzz_rdm')
    statstic_type(case_dataset, 'XiangShan_trigger_dejavuzz')
    statstic_type(case_dataset, 'XiangShan_trigger_dejavuzz_rdm')